        ...
        with theme.frame('- Create a Game -'):
            ...
            with ui.row():
                ...
                ui.input(label='Game Name', placeholder='50 character limit',
                            on_change=lambda e: result.set_text(e.value + ' of 50 characters used.'),
                            validation={'Input too long, limit is 50 characters.': lambda value: len(value) > 50,
            ...
            with ui.row():
                ...
                ui.input(label='Game Description', placeholder='500 character limit',
                            on_change=lambda e: description_result.set_text(e.value + ' of 500 characters used.'),
                            validation={'Input too long, limit is 500 characters.': lambda value: len(value) > 500}
                            ).props('clearable')
